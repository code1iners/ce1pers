...
| `@ce1pers/social-login-redirect` | social login authorization URL·redirect | 1.1.1 | 1.1.1 | [README](./social-login-redirect/README.md) | [npm](https://www.npmjs.com/package/@ce1pers/social-login-redirect) |
...
`저장소 버전`은 각 `package.json`, `npm latest`는 2026-08-21 registry 조회 기준입니다. 불일치가 발생하면 [현재 미구현 과제](./docs/unimplemented/current-unimplemented.md)에서 관리합니다.
